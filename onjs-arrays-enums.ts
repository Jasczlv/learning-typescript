...
//always avoid ANY type, can use but doesn't make sense (typical js behavior) should be inferred by TS or if working with other types explicitly declare them
